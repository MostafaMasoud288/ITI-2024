...
# --------------------------- Open_Block --------------------------- #
open_block /home/user24/mostafa_masoud/dc/ALU/pnr/setup/ALU.dlib:Floorplanning.design

# --------------------------- Copy_design_optional --------------------------- 
#
# copy block to a new block to work on it
copy_block -from_block ALU.dlib:Floorplanning.design -to_block PowerPlanning
...
save_block -as PowerPlanning ALU.dlib:PowerPlanning.design

write_verilog   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/Power_Planning_netlist.v


# --------------------------- Report --------------------------- #

report_cell >   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/PP_cells.rpt

report_qor  >   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/PP_qor.rpt

report_timing -max_paths 10 >   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/PP_timing.rpt

report_timing -delay min -max_paths 10 >   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/PP_timing_hold.rpt

check_legality -verbose >  /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/Power_Planning_legalization.rpt

report_utilization >   /home/user24/mostafa_masoud/dc/ALU/pnr/outputs/Power_Planning_legalization.rpt
